...
if selected == "Project":
    if show_assessment == False:
        ...
        st.sidebar.write (":books: Kindly note that this project is storing assessment data results for research purposes only, and to check the original questions and calculate your score, check out this PDF file:-_ [The Mini-IPIP Scale (Donnellan, Oswald, Baird, & Lucas, ...).](%s)" %quest_link)
