...
if selected == "About":
    ...
    st.write(":two: ML-based Personality Assessment Using Flask python and its libraries to create a model using Logistic Regression with 93% accuracy then uploaded the model on pythonanywhere and The data stored in a Google Sheet for researching purposes only [link.](%s)" % Google_Form_link)
# Footer Format
footer="""<style>
a:link , a:visited{
color: blue;
